...
export const workoutsRoutes = new Elysia()
  ...
  .get(
    "/units",
    ({ set, studentId }) => getUnitsHandler({ set, studentId }),
    { requireStudent: true }
  )
  .post(
    "/units",
  ...
  .delete(
    "/units/:id",
    ({ set, studentId, params }) => deleteUnitHandler({ set, studentId, params }),
    { requireStudent: true }
  )
  .post(
    "/manage",
    ({ set, body, studentId }) => createWorkoutHandler({ set, body, studentId }),
    { requireStudent: true }
  )
  .put(
    "/manage/:id",
  ...
  .post(
    "/exercises",
    ({ set, body, studentId }) => createExerciseHandler({ set, body, studentId }),
    { requireStudent: true }
  )
  .put(
    "/exercises/:id",
