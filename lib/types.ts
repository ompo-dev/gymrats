...
export interface UserProfile {
  ...
  gymType: "academia-completa" | "academia-basica" | "home-gym" | "peso-corporal"
...
export interface CalorieCalculation {
  ...
  calculatedFor: {
    ...
    age: number
    gender: string
    hormonalProfile?: "testosterone-dominant" | "estrogen-dominant" | "balanced"
  }
}
...
export interface Payment {
  ...
  dueDate: Date
  status: "paid" | "pending" | "overdue" | "canceled"
  paymentMethod: "credit-card" | "debit-card" | "cash" | "pix" | "bank-transfer"
  reference?: string
}
