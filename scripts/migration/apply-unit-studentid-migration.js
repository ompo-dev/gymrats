...
async function applyMigration() {
  try {
    ...
    console.log("   - Foreign key constraint criada para relacionamento com students");
    console.log("   - Se studentId for null, o treino é global; se preenchido, é personalizado");
  } catch (error) {
