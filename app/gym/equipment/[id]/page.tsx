    ...
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <Card className="mb-6 border-2 p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6">
          <div className="flex h-24 w-24 sm:h-32 sm:w-32 items-center justify-center rounded-2xl bg-gradient-to-br from-[#58CC02] to-[#47A302] shrink-0">
          ...
          <div className="flex-1 w-full min-w-0">
            <div className="mb-2 flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black text-gray-900 break-words">
                {equipment.name}
              </h1>
              <span
      ...
      {equipment.status === "in-use" && equipment.currentUser && (
        <Card className="mb-6 border-2 border-[#1CB0F6] bg-gradient-to-r from-[#1CB0F6]/10 to-white p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex-1 min-w-0">
              <p className="text-xs sm:text-sm font-bold text-gray-600">
                Equipamento em uso por:
              </p>
              <p className="text-xl sm:text-2xl font-black text-[#1CB0F6] break-words">
      ...
      <div className="mb-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <Card className="border-2 border-[#CE82FF] bg-gradient-to-br from-[#CE82FF]/10 to-white p-4 sm:p-6">
        ...
        <Card className="border-2 border-[#1CB0F6] bg-gradient-to-br from-[#1CB0F6]/10 to-white p-4 sm:p-6">
          <div className="flex items-center gap-2 sm:gap-3">
        ...
        <Card className="border-2 border-[#58CC02] bg-gradient-to-br from-[#58CC02]/10 to-white p-4 sm:p-6">
          <div className="flex items-center gap-2 sm:gap-3">
        ...
        <Card className="border-2 border-[#FF9600] bg-gradient-to-br from-[#FF9600]/10 to-white p-4 sm:p-6">
          <div className="flex items-center gap-2 sm:gap-3">
                ...
                {equipment.maintenanceHistory.map((record) => (
                  ...
                  >
                    <div className="flex flex-col sm:flex-row items-start sm:items-start justify-between gap-3">
                      <div className="flex-1 min-w-0">
                        <p className="font-bold text-gray-900 capitalize text-sm sm:text-base break-words">
                          {record.type}
                        </p>
          ...
          <Card className="border-2 p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col sm:flex-row justify-between gap-2 rounded-xl border-2 p-3 sm:p-4">
                ...
                <span className="text-gray-900 text-sm sm:text-base capitalize break-words">
                  {equipment.type}
                </span>
              </div>
            </div>
