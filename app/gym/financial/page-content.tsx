  ...
  return (
    <div className="container px-4 py-6">
      ...
      {viewMode === "overview" && (
        <div className="space-y-6">
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="rounded-2xl border-2 border-red-200 bg-linear-to-br from-red-50 to-white p-4">
              <div className="mb-2 flex items-center justify-between">
            ...
            <div className="rounded-2xl border-2 border-blue-200 bg-linear-to-br from-blue-50 to-white p-4">
              ...
              <div className="text-2xl font-black text-blue-600">
                R$ {financialSummary.netProfit.toLocaleString()}
              </div>
              <div className="text-xs font-bold text-duo-gray-dark">
                Lucro Líquido
              </div>
            ...
            <div className="rounded-2xl border-2 border-purple-200 bg-linear-to-br from-purple-50 to-white p-4">
              ...
              <div className="text-2xl font-black text-purple-600">
                R$ {financialSummary.monthlyRecurring.toLocaleString()}
              </div>
              <div className="text-xs font-bold text-duo-gray-dark">
                Recorrente Mensal
              </div>
          ...
          <div className="rounded-2xl border-2 border-duo-border bg-white p-5">
            <h3 className="mb-4 text-sm font-black text-duo-gray-darkest">
              Métricas do Mês
            </h3>
      ...
      {viewMode === "payments" && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-black text-duo-gray-darkest">
              Pagamentos Recentes
            </h3>
          ...
          {payments.map((payment) => (
            <div
              key={payment.id}
              className="rounded-2xl border-2 border-duo-border bg-white p-4"
            >
              <div className="mb-3 flex items-start justify-between">
                ...
                <div
                  className={`rounded-lg border-2 px-3 py-1 text-xs font-bold ${getStatusColor(
                    payment.status
                  )}`}
                >
      ...
      {viewMode === "coupons" && (
        <div className="space-y-4">
          ...
          {coupons.map((coupon) => (
            <div
              key={coupon.id}
              className="rounded-2xl border-2 border-yellow-200 bg-linear-to-br from-yellow-50 to-white p-4"
            >
              <div className="mb-3 flex items-start justify-between">
                ...
                {coupon.isActive && (
                  <div className="rounded-lg bg-green-100 px-2 py-1 text-xs font-bold text-green-600">
                    Ativo
                  </div>
                )}
              </div>
      ...
      {viewMode === "referrals" && (
        <div className="space-y-4">
          ...
          {referrals.map((referral) => (
            <div
              key={referral.id}
              className="rounded-2xl border-2 border-purple-200 bg-linear-to-br from-purple-50 to-white p-4"
            >
