      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="border-2 p-4 md:p-6">
          ...
          <div className="space-y-3">
            {month.topStudents.slice(0, 5).map((student, index) => (
              ...
              >
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-linear-to-br from-[#CE82FF] to-[#FF9600] text-sm font-black text-white md:h-10 md:w-10 md:text-lg">
                  {index + 1}
                </div>
                {student.avatar && (
                  <div className="relative h-10 w-10 overflow-hidden rounded-full md:h-12 md:w-12">
        ...
        <Card className="border-2 p-4 md:p-6">
          ...
          <div className="space-y-4">
            <div className="rounded-xl bg-linear-to-r from-[#58CC02]/10 to-white p-4">
              <p className="text-xs font-bold text-gray-600 md:text-sm">
                Total de Check-ins
              </p>
