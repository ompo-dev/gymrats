...
import { LayoutDashboard, Users, Dumbbell, DollarSign, MoreHorizontal } from "lucide-react"
...
function GymLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  // Se estiver em uma página de detalhes, não alterar o tab
  const isInDetailPage = pathname.includes("/students/") || pathname.includes("/equipment/")
