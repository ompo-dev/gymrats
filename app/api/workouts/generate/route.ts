  ...
  try {
    ...
    if (!student || !student.profile) {
      return NextResponse.json(
        { success: false, error: "Perfil do aluno não encontrado. Complete o onboarding primeiro." },
        { status: 404 }
      );
    }
      ...
      await db.unit.deleteMany({
        where: { studentId: studentId },
           ...
           const profile: any = {
             ...
             fitnessLevel: student.profile.fitnessLevel as "iniciante" | "intermediario" | "avancado" | null,
             ...
             preferredRepRange: student.profile.preferredRepRange as "forca" | "hipertrofia" | "resistencia" | null,
             restTime: student.profile.restTime as "curto" | "medio" | "longo" | null,
             gymType: student.profile.gymType as "academia-completa" | "academia-basica" | "home-gym" | "peso-corporal" | null,
