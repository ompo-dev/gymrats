...
### `route.ts`
- O que faz: implementa o endpoint `/api/students/friends` com método(s) `GET`.
- Como: lê request, aplica validações/autorização e delega para handlers/casos de uso (ex.: `GET`, `getFriendsHandler`), serializando resposta HTTP.
