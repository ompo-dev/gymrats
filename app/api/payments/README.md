...
### `route.ts`
- O que faz: implementa o endpoint `/api/payments` com método(s) `GET`.
- Como: lê request, aplica validações/autorização e delega para handlers/casos de uso (ex.: `GET`, `getPaymentsHandler`), serializando resposta HTTP.
