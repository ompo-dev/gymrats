		...
		<DuoCard.Root variant="default" size="default">
			<div className="flex items-start justify-between">
				<div className="flex-1">
					<h3 className="font-bold text-duo-text">{payment.gymName}</h3>
					<p className="text-xs text-duo-gray-dark mt-0.5">{payment.planName}</p>
					...
					<div className="mt-2 flex items-center gap-2">
						<span
							className={cn(
								...
								payment.status === "withdrawn" && "bg-duo-blue/20 text-duo-blue",
								payment.status === "pending" && "bg-duo-yellow/20 text-duo-yellow",
