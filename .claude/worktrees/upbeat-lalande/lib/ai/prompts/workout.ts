/**
 * Prompts especializados para geração e edição de treinos
 *
 * A IA entende comandos de criar, editar e deletar treinos e exercícios
 * dentro de uma Unit (semana de treino)
 */
...
- Segundo treino foco em POSTERIOR: Stiff, Flexora, Levantamento Terra, Leg Curl
      ...
      "exercises": [
        {
          ...
          "alternatives": ["Alternativa 1", "Alternativa 2", "Alternativa 3"] // OBRIGATÓRIO: 2-3 alternativas variando equipamento/pegada
        }
      ]
    }
  ],
