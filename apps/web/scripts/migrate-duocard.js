...
for (const dir of dirs) {
  ...
  for (const file of files) {
    ...
    const orig = content;
    if (
      !content.includes("DuoCard") &&
      !content.includes("DuoCardHeader") &&
      !content.includes("DuoCardContent") &&
      !content.includes("DuoCardFooter")
    )
      continue;
    content = content.replace(
      /import \{ DuoCard, DuoCardHeader \} from/g,
      "import { DuoCard } from",
    );
    content = content.replace(
      /import \{ DuoCard, DuoCardContent, DuoCardFooter, DuoCardHeader \} from/g,
      "import { DuoCard } from",
    );
    content = content.replace(
      /import \{ DuoCardHeader \} from/g,
      "import { DuoCard } from",
    );
    ...
    content = content.replace(
      /DuoCard,\s+DuoCardContent,\s+DuoCardFooter,\s+DuoCardHeader,/g,
      "DuoCard,",
    );
