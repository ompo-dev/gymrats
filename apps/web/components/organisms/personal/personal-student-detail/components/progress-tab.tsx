...
export interface PersonalProgressTabProps {
  progress?: {
    totalXP?: number;
...
export function PersonalProgressTab({ progress }: PersonalProgressTabProps) {
