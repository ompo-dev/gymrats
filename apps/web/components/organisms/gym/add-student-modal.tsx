      ...
      >
        ...
        <div className="mb-6 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-bold text-duo-text">Adicionar Aluno</h2>
          </div>
          <button
            onClick={handleClose}
                ...
                <>
                  ...
                  {selectedPlanId && (
                    <p className="rounded-lg bg-duo-blue/10 px-3 py-2 text-sm text-duo-text">
                      Será criado um pagamento pendente para o aluno. Ele deverá
                      acessar <strong>Perfil → Pagamentos</strong> para quitar e
                      ativar a matrícula.
                    </p>
                  )}
