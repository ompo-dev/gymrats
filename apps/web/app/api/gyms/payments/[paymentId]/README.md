...
- Caminho: `app/api/gyms/payments/[paymentId]`
- Finalidade: raiz do App Router com páginas, layouts e endpoints por filesystem routing.
- Endpoint base deste diretorio: `/api/gyms/payments/[paymentId]`
...
### `route.ts`
- O que faz: implementa o endpoint `/api/gyms/payments/[paymentId]` com método(s) `PATCH`.
