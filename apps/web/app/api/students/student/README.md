...
### `route.ts`
- O que faz: implementa o endpoint `/api/students/student` com método(s) `GET`.
- Como: lê request, aplica validações/autorização e delega para handlers/casos de uso (ex.: `GET`, `getStudentInfoHandler`), serializando resposta HTTP.
