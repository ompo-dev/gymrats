...
- Caminho: `app/student/onboarding/steps`
...
## Arquivos
- `consolidated-step1.tsx`: Arquivo da camada local.
- `consolidated-step2.tsx`: Arquivo da camada local.
- `consolidated-step3.tsx`: Arquivo da camada local.
...
- `step5.tsx`: Arquivo da camada local.
- `step6.tsx`: Arquivo da camada local.
- `step7.tsx`: Arquivo da camada local.
- `types.ts`: Arquivo da camada local.

## Detalhamento técnico por arquivo

### `consolidated-step1.tsx`
...
### `consolidated-step2.tsx`
- O que faz: implementa o módulo `consolidated-step2.tsx` da camada `steps`.
- Como: declara tipos, funções e contratos utilizados por outras partes do sistema.
- Por que: mantém coesão técnica e facilita evolução segura do código.
- Importa principalmente: `./step5`, `./types`
- Expõe: `ConsolidatedStep2`
- Comunica com: camada local sem integrações explícitas detectadas.
- Onde é usado/importado: `app/student/onboarding/page.tsx`

### `consolidated-step3.tsx`
...
- Comunica com: camada local sem integrações explícitas detectadas.
- Onde é usado/importado: `app/student/onboarding/actions.ts`, `app/student/onboarding/page.tsx`, `app/student/onboarding/steps/consolidated-step1.tsx`, `app/student/onboarding/steps/consolidated-step2.tsx`, `app/student/onboarding/steps/consolidated-step3.tsx`, `app/student/onboarding/steps/step1.tsx`, `app/student/onboarding/steps/step2.tsx`, `app/student/onboarding/steps/step3.tsx`, `app/student/onboarding/steps/step4.tsx`, `app/student/onboarding/steps/step5.tsx`, `app/student/onboarding/steps/step6.tsx`, `app/student/onboarding/steps/step7.tsx`
