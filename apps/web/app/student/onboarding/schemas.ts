...
// Schema consolidado para Etapa 1 (Step1 + Step2 + Step4 + Step5 Activity)
export const consolidatedStep1Schema = step1Schema
  .merge(step2Schema)
  .merge(step4Schema)
  .merge(step5Schema_Activity);

export type ConsolidatedStep1Data = z.infer<typeof consolidatedStep1Schema>;

export function validateConsolidatedStep1(
  data: Partial<ConsolidatedStep1Data>,
) {
  return consolidatedStep1Schema.safeParse(data);
}
