...
export function useSubscriptionUnified(options: UseSubscriptionOptions) {
  ...
  return useMemo(
    () => ({
      ...
      refetch,
      startTrial,
      isStartingTrial: meta.isStartingTrial,
      createSubscription,
      isCreatingSubscription: meta.isCreatingSubscription,
      cancelSubscription,
      isCancelingSubscription: meta.isCancelingSubscription,
    }),
    [
      cancelSubscription,
      createSubscription,
      ...
      meta.error,
      meta.isFirstPayment,
      meta.isCancelingSubscription,
      meta.isCreatingSubscription,
      meta.isLoading,
      meta.isStartingTrial,
      refetch,
      startTrial,
      subscription,
    ],
