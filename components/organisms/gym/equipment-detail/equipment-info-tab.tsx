...
const INFO_ITEMS = [
	{ key: "purchaseDate", label: "Data de Compra", getValue: (e: Equipment) => e.purchaseDate?.toLocaleDateString("pt-BR") || "N/A" },
	{ key: "brand", label: "Marca", getValue: (e: Equipment) => e.brand },
	{ key: "model", label: "Modelo", getValue: (e: Equipment) => e.model },
	{ key: "serialNumber", label: "Número de Série", getValue: (e: Equipment) => e.serialNumber },
	{ key: "type", label: "Tipo", getValue: (e: Equipment) => e.type, capitalize: true },
];
