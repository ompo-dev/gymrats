	...
	return (
		<div className="grid gap-6 lg:grid-cols-2">
					...
					<div className="space-y-3">
						<DuoCard.Root variant="default" size="sm">
							<div className="flex justify-between items-center">
								...
								<span className="text-duo-text font-bold">{student.gymMembership.planName}</span>
							</div>
						</DuoCard.Root>
						<DuoCard.Root variant="default" size="sm">
							<div className="flex justify-between items-center">
					...
					{[
						...
						<DuoCard.Root key={info.label} variant="default" size="sm">
							<div className="flex flex-col sm:flex-row justify-between gap-2 sm:gap-0">
								<span className="font-bold text-duo-gray-dark text-sm sm:text-base">{info.label}</span>
								<span className="text-duo-text text-sm sm:text-base wrap-break-words">{info.value}</span>
							</div>
						</DuoCard.Root>
					))}
				</div>
			...
			<DuoCard.Root variant="default" padding="md">
				...
				<h3 className="mb-3 mt-6 font-bold text-duo-text">Equipamentos Favoritos</h3>
				<div className="flex flex-wrap gap-2">
