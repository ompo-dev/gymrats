  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-sm text-duo-gray-dark">Compete com amigos e ganhe recompensas</p>
      </div>
...
function ChallengeCard({ challenge }: { challenge: Challenge }) {
  ...
  return (
    <div className={`rounded-2xl border-2 bg-gradient-to-br p-6 ${getTypeColor(challenge.type)}`}>
      <div className="mb-4 flex items-start justify-between">
        <div>
          <div className="mb-1 text-xl font-bold text-duo-text">{challenge.title}</div>
          <div className="text-sm text-duo-gray-dark">{challenge.description}</div>
        </div>
      ...
      <div className="mb-4">
        <div className="mb-2 flex items-center justify-between text-sm font-bold">
          ...
          <span className="text-duo-gray-dark">{progressPercentage.toFixed(0)}%</span>
        </div>
      ...
      <div className="mt-4 flex items-center gap-2 rounded-lg bg-white/50 p-3">
        ...
        <span className="text-sm font-bold text-duo-text">Recompensa: +{challenge.reward.xp} XP</span>
      </div>
    </div>
  )
}
