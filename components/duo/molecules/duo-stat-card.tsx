...
function DuoStatCardRoot({ className, children, ...props }: DuoStatCardRootProps) {
	return (
		<div
			className={cn(
...
function DuoStatCardValue({ children, className, ...props }: HTMLAttributes<HTMLSpanElement>) {
	return (
		<span
			className={cn("tabular-nums text-xl font-extrabold leading-tight text-[var(--duo-fg)]", className)}
			{...props}
		>
			{children}
		</span>
...
function DuoStatCardLabel({ children, className, ...props }: HTMLAttributes<HTMLSpanElement>) {
	return (
		<span className={cn("truncate text-xs text-[var(--duo-fg-muted)]", className)} {...props}>
			{children}
		</span>
	);
}

function DuoStatCardContent({ children, className, ...props }: HTMLAttributes<HTMLDivElement>) {
	return (
