...
export interface StatCardLargeProps extends React.HTMLAttributes<HTMLDivElement> {
  icon: LucideIcon
  value: string | number
  label: string
  subtitle?: string
  iconColor?: "duo-orange" | "duo-yellow" | "duo-blue" | "duo-green" | "duo-purple" | "duo-red"
}
...
export function StatCardLarge({
  ...
  return (
    <DuoCard variant="default" size="md" className={cn("text-center", className)} {...props}>
