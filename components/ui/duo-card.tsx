  ...
  "bg-white transition-all",
  {
    variants: {
      variant: {
        ...
        highlighted: "rounded-xl border-2 border-duo-green bg-duo-green/10 shadow-[0_2px_0_#58A700]",
        blue: "rounded-xl border-2 border-duo-blue bg-duo-blue/10 shadow-[0_2px_0_#1899D6]",
        orange: "rounded-xl border-2 border-duo-orange bg-duo-orange/10 shadow-[0_2px_0_#E68A00]",
        yellow: "rounded-xl border-2 border-duo-yellow bg-duo-yellow/10 shadow-[0_2px_0_#E6B800]",
      },
      size: {
        default: "p-6",
        sm: "p-3",
