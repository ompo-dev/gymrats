...
- Caminho: `docs/04-domain/payments`
...
## Arquivos
- `FLUXO_PAGAMENTOS_COMPLETO.md`: Arquivo da camada local.

## Detalhamento técnico por arquivo

### `FLUXO_PAGAMENTOS_COMPLETO.md`
- O que faz: documenta decisões e operação referentes a `docs/04-domain/payments/FLUXO_PAGAMENTOS_COMPLETO.md`.
