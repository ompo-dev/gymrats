...
### `API_COMPLETA.md`
- O que faz: documenta decisões e operação referentes a `docs/03-backend/api/API_COMPLETA.md`.
...
- Comunica com: Autenticação/sessão, HTTP interno/externo, Runtime Elysia
