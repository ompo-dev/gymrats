...
export const duolingoPresets: ThemePreset[] = [
	buildPreset("duo-green", "Duolingo Classic", "duoGreen", darkSurfaces.duoGreen),
	buildPreset("duo-blue", "Ocean Blue", "duoBlue", darkSurfaces.duoBlue),
	buildPreset("duo-purple", "Royal Purple", "duoPurple", darkSurfaces.duoPurple),
	buildPreset("duo-pink", "Flamingo Pink", "duoPink", darkSurfaces.duoPink),
	buildPreset("duo-orange", "Sunset Orange", "duoOrange", darkSurfaces.duoOrange),
];

/** Presets light - fundo claro, texto escuro */
export const duolingoPresetsLight: ThemePreset[] = [
	buildPreset("duo-green-light", "Duolingo Classic (Claro)", "duoGreen", lightSurfaces.duoGreen),
	buildPreset("duo-blue-light", "Ocean Blue (Claro)", "duoBlue", lightSurfaces.duoBlue),
	buildPreset("duo-purple-light", "Royal Purple (Claro)", "duoPurple", lightSurfaces.duoPurple),
	buildPreset("duo-pink-light", "Flamingo Pink (Claro)", "duoPink", lightSurfaces.duoPink),
	buildPreset("duo-orange-light", "Sunset Orange (Claro)", "duoOrange", lightSurfaces.duoOrange),
];
