...
export default function StatsPage({ stats, equipment }: StatsPageProps) {
  const weeklyData = [
  ...
  return (
    <div className="container px-4 py-6">
      ...
      <div className="mb-6 grid grid-cols-2 gap-3">
        ...
        <div className="rounded-2xl border-2 border-green-200 bg-linear-to-br from-green-50 to-white p-4">
          <div className="mb-2 flex items-center justify-between">
        ...
        <div className="rounded-2xl border-2 border-purple-200 bg-linear-to-br from-purple-50 to-white p-4">
          <div className="mb-2 flex items-center justify-between">
            <Target className="h-5 w-5 text-purple-500" />
            <div className="flex items-center gap-1 text-xs font-bold text-duo-gray-dark">
              85%
            </div>
          </div>
          <div className="text-2xl font-black text-purple-600">
            {stats.week.avgDailyCheckins}
          </div>
          <div className="text-xs font-bold text-duo-gray-dark">
            Média Diária
          </div>
        ...
        <div className="rounded-2xl border-2 border-orange-200 bg-linear-to-br from-orange-50 to-white p-4">
          <div className="mb-2 flex items-center justify-between">
          ...
          {weeklyData.map((day) => (
            <div key={day.day} className="space-y-1">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-black text-duo-gray-darkest">
                  {day.checkins}
                </span>
              </div>
              <div className="h-3 w-full overflow-hidden rounded-full bg-gray-100">
                <div
                  className="h-full rounded-full bg-linear-to-r from-duo-green to-green-400 transition-all"
          ...
          {hourlyData.map((item) => (
            <div key={item.hour} className="flex items-center gap-3">
              ...
              <div className="relative h-8 flex-1 overflow-hidden rounded-lg bg-gray-100">
                <div
                  className="flex h-full items-center rounded-lg bg-linear-to-r from-[#FF9600] to-orange-400 px-2 text-xs font-black text-white transition-all"
                  style={{
              ...
              <div className="w-8 text-right text-xs font-bold text-duo-gray-darkest">
                {item.students}
              </div>
            </div>
          ))}
      ...
      <div className="rounded-2xl border-2 border-duo-border bg-white p-5">
        ...
        <div className="space-y-3">
          {equipment.slice(0, 5).map((eq, index) => (
            <div
              key={eq.id}
              className="flex items-center gap-3 rounded-xl border-2 border-gray-100 bg-gray-50 p-3"
            >
              ...
              <div className="text-right">
                <div className="text-sm font-black text-duo-blue">
